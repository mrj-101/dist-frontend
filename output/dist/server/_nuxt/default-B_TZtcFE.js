import { useSlots, computed, unref, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, useSSRContext, toRef, toHandlers, createVNode, reactive, createTextVNode, Fragment, renderList, resolveDynamicComponent, withModifiers, defineComponent, ref, isRef } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderVNode, ssrRenderAttrs, ssrRenderAttr } from "vue/server-renderer";
import { Primitive, useForwardPropsEmits, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, DialogRoot, DialogTrigger, DialogPortal, DialogOverlay, DialogContent, VisuallyHidden, DialogTitle, DialogDescription, DialogClose } from "reka-ui";
import { defu } from "/Users/surachai/Dev/rvc2026/frontend/node_modules/defu/dist/defu.mjs";
import { reactivePick, createSharedComposable, createReusableTemplate } from "@vueuse/core";
import { b as useAppConfig, k as useButtonGroup, l as useComponentIcons, t as tv, c as _sfc_main$7, m as _sfc_main$8, n as usePortal, o as isArrayOfArray, g as get, p as _sfc_main$9, q as pickLinkProps, r as _sfc_main$a, s as useLocale, v as _sfc_main$b, f as useState } from "../server.mjs";
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
                          ...
                          __props.orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || __props.orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$7, {
                            key: 1,
                            name: item.trailingIcon || __props.trailingIcon || unref(appConfig).ui.icons.chevronDown,
                            class: ui.value.linkTrailingIcon({ class: [props.ui?.linkTrailingIcon, item.ui?.linkTrailingIcon], active })
            ...
            return [
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                (!__props.collapsed || __props.orientation !== "vertical") && (unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"]) ? (openBlock(), createBlock("span", {
                  ...
                  item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$7, {
                    key: 0,
                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                    class: ui.value.linkLabelExternalIcon({ class: [props.ui?.linkLabelExternalIcon, item.ui?.linkLabelExternalIcon], active })
                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
                                                            ...
                                                            if (_push9) {
                                                              ...
                                                              return [
                                                                ...
                                                                createVNode("span", {
                                                                  ...
                                                                  childItem.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$7, {
                                                                    key: 0,
                                                                    name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                                                                    class: ui.value.childLinkLabelExternalIcon({ class: [props.ui?.childLinkLabelExternalIcon, item.ui?.childLinkLabelExternalIcon], active: childActive })
                                                                  }, null, 8, ["name", "class"])) : createCommentVNode("", true)
...
//# sourceMappingURL=default-B_TZtcFE.js.map
