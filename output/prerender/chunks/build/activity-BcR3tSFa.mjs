...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UContainer, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1${_scopeId}>Activity</h1>`);
      } else {
        return [
          createVNode("h1", null, "Activity")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/job/activity.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const activity = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { activity as default };
//# sourceMappingURL=activity-BcR3tSFa.mjs.map
