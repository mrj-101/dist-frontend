import { _ as _sfc_main$1 } from './Container-YnYdMvQP.mjs';
import { withCtx, createVNode, useSSRContext } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UContainer, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1${_scopeId}>Administrator</h1>`);
      } else {
        return [
          createVNode("h1", null, "Administrator")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/base/administrator.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const administrator = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { administrator as default };
//# sourceMappingURL=administrator-BPgf4zCd.mjs.map
