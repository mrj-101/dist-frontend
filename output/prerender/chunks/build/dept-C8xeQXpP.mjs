...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dept/dept.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const dept = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { dept as default };
//# sourceMappingURL=dept-C8xeQXpP.mjs.map
