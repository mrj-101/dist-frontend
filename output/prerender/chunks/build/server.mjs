import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, mergeProps, unref, hasInjectionContext, inject, toRef, isRef, computed, toValue, getCurrentInstance, onServerPrefetch, ref, watch, createVNode, resolveDynamicComponent, withCtx, renderSlot, createBlock, openBlock, toDisplayString, provide, useSlots, createCommentVNode, useAttrs, nextTick, mergeModels, useModel, createTextVNode, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/ofetch/dist/node.mjs';
import { h as baseURL } from '../nitro/nitro.mjs';
import { createHooks } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/unctx/dist/index.mjs';
import { appendHeader, createError as createError$1, sanitizeStatusCode } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/radix3/dist/index.mjs';
import { defuFn, defu } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, withQuery, withTrailingSlash, withoutTrailingSlash, isScriptProtocol, withLeadingSlash, parseURL, encodeParam, encodePath } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/ufo/dist/index.mjs';
import colors from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/tailwindcss/dist/colors.mjs';
import { klona } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/klona/dist/index.mjs';
import { Icon, getIcon, loadIcon as loadIcon$1, _api, addAPIProvider, setCustomIconsLoader } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/@iconify/vue/dist/iconify.mjs';
import { ssrRenderComponent, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderSuspense, ssrRenderStyle } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/vue/server-renderer/index.mjs';
import { useForwardProps, Primitive, Slot, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, useForwardPropsEmits, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, ProgressRoot, ProgressIndicator } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/reka-ui/dist/index.js';
import { reactivePick, reactiveOmit, createSharedComposable } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/@vueuse/core/index.mjs';
import { createTV } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/tailwind-variants/dist/index.js';
import { getIconCSS } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/@iconify/utils/lib/css/icon.mjs';
import { debounce } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs';
import { isEqual, diff } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/ohash/dist/utils.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CC9_j95s.mjs')
  },
  {
    name: "base-rvc",
    path: "/base/rvc",
    component: () => import('./rvc-BeMC3VI1.mjs')
  },
  {
    name: "job-plan",
    path: "/job/plan",
    component: () => import('./plan-Bi1_Slzf.mjs')
  },
  {
    name: "dept-dept",
    path: "/dept/dept",
    component: () => import('./dept-C8xeQXpP.mjs')
  },
  {
    name: "base-board",
    path: "/base/board",
    component: () => import('./board-CCf-b7Bv.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-6C1TCI7e.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-B_CaNxop.mjs')
  },
  {
    name: "base-contact",
    path: "/base/contact",
    component: () => import('./contact-Cpk5nWQh.mjs')
  },
  {
    name: "base-mission",
    path: "/base/mission",
    component: () => import('./mission-CMFJE2iB.mjs')
  },
  {
    name: "job-academic",
    path: "/job/academic",
    component: () => import('./academic-FZm38MbG.mjs')
  },
  {
    name: "job-activity",
    path: "/job/activity",
    component: () => import('./activity-BcR3tSFa.mjs')
  },
  {
    name: "job-resource",
    path: "/job/resource",
    component: () => import('./resource-B3HH8kYh.mjs')
  },
  {
    name: "dept-graduate",
    path: "/dept/graduate",
    component: () => import('./graduate-87MgA6Mb.mjs')
  },
  {
    name: "private",
    path: "/private",
    component: () => import('./index-DOz4hkNI.mjs')
  },
  {
    name: "curriculum-grade2",
    path: "/curriculum/grade2",
    component: () => import('./grade2-FBHPYWiR.mjs')
  },
  {
    name: "curriculum-grade3",
    path: "/curriculum/grade3",
    component: () => import('./grade3-CXZiiuh3.mjs')
  },
  {
    name: "curriculum-grade4",
    path: "/curriculum/grade4",
    component: () => import('./grade4-dog6x4Nc.mjs')
  },
  {
    name: "base-administrator",
    path: "/base/administrator",
    component: () => import('./administrator-BPgf4zCd.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DvXncYto.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CftKAaRp.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-DPlnOohn.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-Pg249BJl.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-BzhgchVz.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-DhTjA0-c.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-DjP8VRq2.mjs').then((r) => r["default"] || r.default || r));
...
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-CMWKbbwX.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-Dr7V1eZA.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-DXzR1Mf5.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-BATwUPAh.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-ZKhFjPo1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-XsRMPyrr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-B6cACYpF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-WPXz6Zay.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-BFl4Zgpy.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-B3-1pawF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C9E5gQWP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-Bygf1Jwr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-jhrpHHu4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bh5TdnU7.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-D23j5ZP4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-_pnFF0Mb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-C-U5cCy1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-DbaozXBU.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-oII2Gzs4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-BvwRue_H.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-fQUDelbx.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-Dv2m7uDQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-84KgqI1K.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-IvB0lpCK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-BJMizBcP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-ChMfwlLc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-DAfT8pK7.mjs').then((r) => r["default"] || r.default || r));
...
async function _imageMeta(url) {
  {
    const imageMeta2 = await import('file:///Users/surachai/Dev/rvc2026/frontend/node_modules/image-meta/dist/index.mjs').then((r) => r.imageMeta);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-B_TZtcFE.mjs').then((m) => m.default || m)),
  "full-layout": defineAsyncComponent(() => import('./full-layout-BrwflJd8.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CcWLoLq0.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-k_xgR-az.mjs'));
...
export { ImageComponent as I, _export_sfc as _, __nuxt_component_0$1 as a, useAppConfig as b, _sfc_main$e as c, useRoute as d, entry$1 as default, useRuntimeConfig as e, useState as f, get as g, useAsyncData as h, useRequestEvent as i, useNuxtApp as j, useButtonGroup as k, useComponentIcons as l, _sfc_main$b as m, usePortal as n, isArrayOfArray as o, _sfc_main$9 as p, pickLinkProps as q, _sfc_main$a as r, useLocale as s, tv as t, useHead as u, _sfc_main$8 as v };
