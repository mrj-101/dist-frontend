...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UContainer, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1${_scopeId}>\u0E23\u0E30\u0E14\u0E31\u0E1A \u0E1B.\u0E15\u0E23\u0E35</h1>`);
      } else {
        return [
          createVNode("h1", null, "\u0E23\u0E30\u0E14\u0E31\u0E1A \u0E1B.\u0E15\u0E23\u0E35")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/dept/graduate.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const graduate = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { graduate as default };
//# sourceMappingURL=graduate-87MgA6Mb.mjs.map
