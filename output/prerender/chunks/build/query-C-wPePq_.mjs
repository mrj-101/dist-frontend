import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/surachai/Dev/rvc2026/frontend/node_modules/ohash/dist/index.mjs';
import { e as useRuntimeConfig, i as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-Lv3UXNyd.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-C-wPePq_.mjs.map
