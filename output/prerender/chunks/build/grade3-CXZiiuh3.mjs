...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_UContainer, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<h1${_scopeId}>\u0E23\u0E30\u0E14\u0E31\u0E1A \u0E1B\u0E27\u0E2A.</h1>`);
      } else {
        return [
          createVNode("h1", null, "\u0E23\u0E30\u0E14\u0E31\u0E1A \u0E1B\u0E27\u0E2A.")
        ];
      }
    }),
    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/curriculum/grade3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const grade3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { grade3 as default };
//# sourceMappingURL=grade3-CXZiiuh3.mjs.map
