...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/curriculum/grade4.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const grade4 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { grade4 as default };
//# sourceMappingURL=grade4-dog6x4Nc.mjs.map
